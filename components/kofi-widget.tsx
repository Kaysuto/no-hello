        ...
        >
            ...
            >
                <div className="bg-[#FF5F5F] hover:bg-[#ff4f4f] text-white p-3 md:p-4 rounded-full shadow-2xl transition-all hover:scale-110 flex items-center group relative overflow-hidden">
                    ...
                    <span className="max-w-0 overflow-hidden group-hover:max-w-[150px] transition-all duration-500 ease-in-out whitespace-nowrap ml-0 group-hover:ml-3 font-bold uppercase text-xs tracking-wider relative z-10">
                        {t.kofiSupport}
                    </span>
                </div>
            </ExternalLink>
